...
def evaluate_with_llm(conn, test_result_id: int, html_content: str, guideline_content: str, test_file_title: str, model_name='gemini-1.5-flash', use_groq=False, use_claude=False, case_1=False):
...
def evaluate_url():
    ...
    try:
        ...
        for section in main_sections:
            ...
            if similar_guidelines and similar_guidelines[0]['score'] > 0.5:  # 유사도 임계값 설정
